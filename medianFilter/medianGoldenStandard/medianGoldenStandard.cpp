...
int main(){
	...
	ifstream infile("./img/img_pgm/baboon_sp.pgm");
	stringstream ss;
	string inputLine = "";

	// First line : version
	getline(infile,inputLine);
	if(inputLine.compare("P2 480 361 255") != 0) cerr << "Version error" << endl; //Version error if first line doesn't match
	...
	outfile.open("baboon_sp_filtered.pgm");
	outfile<<"P2"<<endl;
